...
class SimpleAdaptiveSlider {
  ...
  static EL_WRAPPER = `${SimpleAdaptiveSlider.PREFIX}__wrapper`;
  static EL_ITEM = `${SimpleAdaptiveSlider.PREFIX}__item`;
  static EL_ITEM_ACTIVE = `${SimpleAdaptiveSlider.PREFIX}__item_active`;
  static EL_ITEMS = `${SimpleAdaptiveSlider.PREFIX}__items`;
  static EL_INDICATOR = `${SimpleAdaptiveSlider.PREFIX}__indicator`;
  static EL_INDICATOR_ACTIVE = `${SimpleAdaptiveSlider.PREFIX}__indicator_active`;
  static EL_INDICATORS = `${SimpleAdaptiveSlider.PREFIX}__indicators`;
  static EL_CONTROL = `${SimpleAdaptiveSlider.PREFIX}__btn`;
